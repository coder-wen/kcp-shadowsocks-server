...
RUN wget --no-check-certificate https://download.docker.com/linux/static/stable/x86_64/docker-18.06.1-ce.tgz && \
	tar xvfz docker-18.06.1-ce.tgz && \
	cp docker/docker /usr/local/bin && \
	rm -rf docker-18.06.1-ce.tgz docker

# Install kcptun
RUN wget -O /root/kcptun-linux-amd64.tar.gz https://github.com/xtaci/kcptun/releases/download/v20180810/kcptun-linux-amd64-20180810.tar.gz && \
...
ENV SS_PASSWORD=1234567 SS_METHOD=aes-256-cfb \
	...
	KCPTUN_SNDWND=1024 KCPTUN_RCVWND=1024 KCPTUN_MODE=fast
